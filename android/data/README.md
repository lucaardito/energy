...
The criteria for the selection of a system call is time-related. In particular, the power analysis will be performed, where possible, for those whose the average total duration (calculated as the average frequency times the average duration) covers at least the 95% of the total time. Base on this, the involved functions are:
* clock\_gettime()
* epoll\_pwait()
* futex()
* gettimeofday()
